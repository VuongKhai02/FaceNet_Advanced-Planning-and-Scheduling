                                        ...
                                        <Table key={"type"} id='type' dataSource={data2} rowKey='position' bordered pagination={false}>
                                            ...
                                            <Table.ColumnGroup title='Lỗ ngoài/Outside Hole'>
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return index !== 2 ? (
                                                            ...
                                                            <SelectBox value={techFormData.tfIcInfo?.machine} width={250} placeholder='Lựa chọn' />
                                                        );
                                                    }}
                                                />
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return record.position === "Kích thước/Size" ? (
                                                            <Input value={techFormData.tfIcInfo?.outsideHoleWidth}
                                                                // className='inputRow'
                                                                onChange={(e) => {
                                                ...
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return record.position === "Kích thước/Size" ? (
                                                            <Input value={techFormData.tfIcInfo?.outsideHoleDepth}
                                                                // className='inputRow'
                                                                onChange={(e) => {
                                                ...
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return record.position === "Kích thước/Size" ? (
                                                            ...
                                                            }} value={techFormData.tfIcInfo?.outsideHoleDiameter}
                                                                // className='inputRow'
                                                                placeholder='Nhập' />
                                                        ) : null;
                                                    }}
                                            ...
                                            <Table.ColumnGroup title='Lỗ trong/Inside Hole'>
                                                ...
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return record.position === "Kích thước/Size" ? (
                                                            <Input value={techFormData.tfIcInfo?.insideHoleWidth}
                                                                // className='inputRow'
                                                                onChange={(e) => {
                                                ...
                                                <Table.Column
                                                    ...
                                                    render={(value, record: any, index) => {
                                                        return record.position === "Kích thước/Size" ? (
                                                            <Input value={techFormData.tfIcInfo?.insideHoleDepth}
                                                                // className='inputRow'
                                                                onChange={(e) => {
                            ...
                            <div className='noteRemark'>
                                ...
                                <div className='rectangle-container'>
                                    ...
                                    <div className='text-section'>
                                        ...
                                        <img
                                            src='https://img6.thuthuatphanmem.vn/uploads/2022/09/13/mau-chu-ky-ten-thiep-dep_013433205.png'
                                            width={100}
                                            height={100}
                                        />
