...
export type FeederGroupViewName =
  | "_base"
  | "_instance_name"
  | "_local"
  | "feeder-group-with-feeders";
export type FeederGroupView<V extends FeederGroupViewName> = V extends "_base"
  ? Pick<
      FeederGroup,
      "id" | "name" | "createdAt" | "feederGroupCode" | "equipmentType" | "type" | "updatedAt"
    >
  ...
  ? Pick<
      FeederGroup,
      "id" | "createdAt" | "feederGroupCode" | "name" | "equipmentType" | "type" | "updatedAt"
    >
