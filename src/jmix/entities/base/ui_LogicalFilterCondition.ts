...
export type LogicalFilterConditionViewName = "_base" | "_instance_name" | "_local";
export type LogicalFilterConditionView<V extends LogicalFilterConditionViewName> = V extends "_base"
