...
export type TemplateTableDescriptionViewName = "_base" | "_instance_name" | "_local";
export type TemplateTableDescriptionView<V extends TemplateTableDescriptionViewName> = never;
