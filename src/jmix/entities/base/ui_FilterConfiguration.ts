...
export type FilterConfigurationView<V extends FilterConfigurationViewName> = V extends "_base"
    ? Pick<FilterConfiguration, "id" | "name" | "componentId" | "configurationId" | "username" | "defaultForAll" | "sysTenantId">
    : V extends "_instance_name"
    ? Pick<FilterConfiguration, "id" | "name">
    : V extends "_local"
    ? Pick<FilterConfiguration, "id" | "componentId" | "configurationId" | "name" | "username" | "defaultForAll" | "sysTenantId">
    : never;
