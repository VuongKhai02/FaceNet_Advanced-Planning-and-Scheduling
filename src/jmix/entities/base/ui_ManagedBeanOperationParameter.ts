...
export type ManagedBeanOperationParameterViewName = "_base" | "_instance_name" | "_local";
export type ManagedBeanOperationParameterView<V extends ManagedBeanOperationParameterViewName> = never;
