...
export type ReferenceToEntityView<V extends ReferenceToEntityViewName> = V extends "_base"
    ? Pick<ReferenceToEntity, "entityId" | "stringEntityId" | "intEntityId" | "longEntityId">
    : V extends "_local"
    ? Pick<ReferenceToEntity, "entityId" | "stringEntityId" | "intEntityId" | "longEntityId">
    : never;
