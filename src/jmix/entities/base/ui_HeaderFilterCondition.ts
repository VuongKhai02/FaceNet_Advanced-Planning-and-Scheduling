...
export type HeaderFilterConditionViewName = "_base" | "_instance_name" | "_local";
export type HeaderFilterConditionView<V extends HeaderFilterConditionViewName> = V extends "_base"
