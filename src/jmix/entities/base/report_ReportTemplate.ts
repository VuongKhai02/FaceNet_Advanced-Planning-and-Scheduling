...
export type ReportTemplateViewName = "_base" | "_instance_name" | "_local" | "reportTemplate.withOutputType" | "template.edit";
export type ReportTemplateView<V extends ReportTemplateViewName> = V extends "_base"
    ? Pick<
          ReportTemplate,
          | "id"
          | "code"
    ...
    ? Pick<ReportTemplate, "id" | "code" | "name" | "customDefinition" | "custom" | "reportOutputType">
