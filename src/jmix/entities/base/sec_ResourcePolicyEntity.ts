...
export type ResourcePolicyEntityViewName = "_base" | "_instance_name" | "_local";
export type ResourcePolicyEntityView<V extends ResourcePolicyEntityViewName> = V extends "_base"
    ? Pick<
