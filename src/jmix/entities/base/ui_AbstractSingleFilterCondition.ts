...
export type AbstractSingleFilterConditionViewName = "_base" | "_instance_name" | "_local";
export type AbstractSingleFilterConditionView<V extends AbstractSingleFilterConditionViewName> = V extends "_base"
