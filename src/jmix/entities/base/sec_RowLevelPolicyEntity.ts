...
export type RowLevelPolicyEntityViewName = "_base" | "_instance_name" | "_local";
export type RowLevelPolicyEntityView<V extends RowLevelPolicyEntityViewName> = V extends "_base"
    ? Pick<
