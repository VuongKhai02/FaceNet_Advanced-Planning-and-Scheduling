...
export type ReportInputParameterViewName = "_base" | "_instance_name" | "_local";
export type ReportInputParameterView<V extends ReportInputParameterViewName> = V extends "_base"
