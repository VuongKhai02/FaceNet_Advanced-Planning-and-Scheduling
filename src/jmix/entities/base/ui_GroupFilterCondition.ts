...
export type GroupFilterConditionViewName = "_base" | "_instance_name" | "_local";
export type GroupFilterConditionView<V extends GroupFilterConditionViewName> = V extends "_base"
