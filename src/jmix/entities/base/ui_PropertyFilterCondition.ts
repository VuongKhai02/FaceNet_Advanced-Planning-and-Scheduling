...
export type PropertyFilterConditionViewName = "_base" | "_instance_name" | "_local";
export type PropertyFilterConditionView<V extends PropertyFilterConditionViewName> = V extends "_base"
