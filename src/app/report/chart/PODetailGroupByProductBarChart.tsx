...
export const PODetailGroupByProductBarChart = (props) => {
    ...
    function done(e) {
        if (chartData.length > 13) {
            e.component.zoomArgument(chartData[0].productName, chartData[13].productName);
        }
    }

    return (
        <Chart
            title='Thông tin sản xuất sản phẩm'
            ...
            <CommonSeriesSettings argumentField='productName'>
                <Label visible={true}>
            ...
            <ValueAxis name='frequency2' position='right' tickInterval={50} showZero={true} valueMarginsEnabled={false}></ValueAxis>
            <ValueAxis name='frequency' position='left' tickInterval={300} />
            <Legend verticalAlignment='bottom' horizontalAlignment='center' columnCount={3}>
