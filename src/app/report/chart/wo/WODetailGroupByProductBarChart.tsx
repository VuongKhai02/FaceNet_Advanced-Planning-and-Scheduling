...
export const WODetailGroupByProductBarChart = (props) => {
    ...
    return (
        <Chart title='Thông tin sản xuất sản phẩm' dataSource={chartData} palette='Harmony Light' id='chart' onDone={done}>
