...
export const WODetailGroupByBranchBarChart = (props) => {
    ...
    return (
        <Chart title='Tổng tiến độ nhập kho các bộ phận sản xuất' dataSource={chartData} palette='Harmony Light' id='chart'>
