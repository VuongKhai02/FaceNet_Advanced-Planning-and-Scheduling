            ...
            >
                <div className="mt-24">
                    ...
                    >
                        ...
                        <p className="ant-upload-text">Kéo thả file hoặc <a style={{ color: '#FF7A00', textDecoration: 'underline' }}>Chọn file</a> để tải lên</p>
                        <p className="ant-upload-hint">Chỉ cho phép file dạng .xls, .xlsx và dung lượng không quá 1MB</p>
                        <p className="link template" onClick={downloadTemplate}>
