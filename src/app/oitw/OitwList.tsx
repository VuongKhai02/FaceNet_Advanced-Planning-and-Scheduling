...
const ENTITY_NAME = "Oitw";
const ROUTING_PATH = "/oitwList";

const OITW_LIST = gql`
    query OitwList($limit: Int, $offset: Int, $orderBy: inp_OitwOrderBy, $filter: [inp_OitwFilterCondition]) {
        OitwCount(filter: $filter)
        OitwList(limit: $limit, offset: $offset, orderBy: $orderBy, filter: $filter) {
            id
            _instanceName
            isCommited
            itemCode
...
const OitwList = observer((props: EntityListProps<Oitw>) => {
    ...
    return (
        <DataTable
            ...
            columnDefinitions={["isCommited", "itemCode", "onHand", "onOrder", "whsCode"]}
