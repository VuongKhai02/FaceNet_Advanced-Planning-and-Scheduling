...
const AppHeader = observer(({ children }: { children?: React.ReactNode }) => {
    ...
    const avatarImage = selectedLanguage === "en" ? "assets/images/GreatBritainFlag.png" : "assets/images/VietNamFlag.png";
    ...
    return (
        <div className='app-header'>
            ...
            <div className='app-header__user-panel__logout-btn' style={{ fontSize: "20px", flexGrow: 1 }}>
            ...
            <Space style={{ marginRight: 20 }}>
                {isFullScreen ? (
                    <FullscreenExitOutlined className='fullscreen-icon' onClick={toggleFullScreen} />
                ) : (
                    <FullscreenOutlined className='fullscreen-icon' onClick={toggleFullScreen} />
                )}
            </Space>
