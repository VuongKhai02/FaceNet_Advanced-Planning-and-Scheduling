...
export const DashboardPOQuantityGroupById = (props) => {
    ...
    return (
        <Chart title='Tiến độ sản xuất các đơn hàng' dataSource={chartData} palette='Harmony Light' id='chart'>
