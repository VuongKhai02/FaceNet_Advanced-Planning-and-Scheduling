...
const allowedPageSizes: "auto" | (number | "all" | "auto")[] | undefined = [10, 15, "all"];
...
export const BusinessLogPopup = (props) => {
    ...
    return (
        <DataGrid
            ...
            />
            <Column dataField='woId' minWidth={160} caption='Primary Id'></Column>
            <Column dataField='actionName' minWidth={180} caption='Action Name'>
                <Lookup dataSource={actionList} displayExpr={"actionName"} valueExpr={"actionCode"} />
            </Column>
            <Column dataField='referenceId' caption='Reference Id'></Column>
            <Column dataField='startTime' dataType='datetime' format={"dd-MM-yyyy HH:mm:ss"} width={190} caption='Start Time'></Column>
            <Column dataField='endTime' dataType='datetime' format={"dd-MM-yyyy HH:mm:ss"} width={190} caption='End Time'></Column>
            <Column dataField='duration' caption='Duration'></Column>
            ...
            {/*</Column>*/}
            <Column dataField='userName' caption='User Name'></Column>
            <Column dataField='outData' caption='Data'></Column>
        </DataGrid>
    );
};
