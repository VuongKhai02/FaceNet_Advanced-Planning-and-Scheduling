...
const Spline = () => {
    const [type, setType] = useState<"spline" | "stackedspline" | "fullstackedspline">("spline");
    ...
    return (
        <React.Fragment>
            <Chart palette='Violet' dataSource={sharingStatisticsInfo} title='Architecture Share Over Time (Count)'>
            ...
            <div className='options'>
                ...
                <div className='option'>
                    ...
                    <SelectBox dataSource={types} value={type} onValueChanged={handleChange} />
                </div>
            </div>
        </React.Fragment>
    );
