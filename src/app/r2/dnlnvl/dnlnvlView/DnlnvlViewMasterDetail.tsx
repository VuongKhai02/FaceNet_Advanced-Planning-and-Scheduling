...
const DnlnvlViewMasterDetail: React.FC<DnlnvlViewProps> = ({ planningWorkOrder = undefined, data }) => {
    ...
    const loadDnlnvl = async () => {
        if (planningWorkOrder && planningWorkOrder.woId) {
            ...
            <div id='dnlnvl-view'>
                ...
                <div>
                    ...
                    <DataGrid
                        ...
                        />
                        <Column type='buttons' cellRender={buttonCellRender} width={145} caption={"Tùy chọn"} alignment='center'></Column>
...
export default DnlnvlViewMasterDetail;
