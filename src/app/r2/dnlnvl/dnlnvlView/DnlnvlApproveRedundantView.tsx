...
import { StatusApproveEnum, ReturnMaterialStatuses } from "../../enum/statusEnum";
import DnlnvlApproveRedundantPopupView from "../DnlnvlApproveRedundant/DnlnvlApproveReduntdantPopupView";
import DnlnvlApproveRedundantHistory from "../DnlnvlApproveRedundant/DnlnvlApproveReduntdantHistory";
...
const DnlnvlApproveRedundantView: React.FC<DnlnvlViewProps> = observer(({ planningWorkOrder = undefined }) => {
    ...
    const [approveHistoryIsOpen, setApproveHistoryIsOpen] = useState(false);
        ...
        <>
            {popupDetailIsOpen && (
                <DnlnvlApproveRedundantPopupView
                    ...
                    onClose={setPopUpDetailClose}
                />
            )}
            {approveHistoryIsOpen ? (
                <DnlnvlApproveRedundantHistory planningWorkOrder={planningWorkOrder} setClose={() => setApproveHistoryIsOpen(false)} />
            ) : (
                <div id='dnlnvl-approve-redundant-view'>
                    <div>
                        <div
                            className='informer'
                            style={{
                            ...
                            <h5
                                ...
                                Danh sách Work Order chứa NVL dư thừa chờ phê duyệt
                            </h5>
                        </div>
                        <div
                            className='informer'
                        ...
                        <DataGrid
                            ...
                            <Toolbar>
                                ...
                                {/*    <h5 className="name">Danh sách Work order chứa NVL dư thừa chờ phê duyệt</h5>*/}
                                {/*  </div>*/}
                                {/*</ToolbarItem1>*/}
                                ...
                                <ToolbarItem1>
                                    <Button icon='refresh' hint='Làm mới' onClick={() => loadDnlnvl()} />
                                </ToolbarItem1>
                                <ToolbarItem1 location={"after"}>
                                    <Button icon='history' hint='Lịch sử phê duyệt' onClick={() => setApproveHistoryIsOpen(true)} />
                                </ToolbarItem1>
                            </Toolbar>
...
export default DnlnvlApproveRedundantView;
