            ...
            <DataGrid
                ...
                <Toolbar>
                    <TItem location={"before"}>
                        <div className={"master-detail-title"}>Danh sách BOM cụ thể</div>
                    </TItem>
                ...
                <Column dataField='productCode' minWidth={140} caption='Mã phiếu công nghệ' cellRender={getProductCode}></Column>
                <Column dataField='productName' caption='Tên thẻ' cellRender={getProductName} minWidth={200}></Column>

                <Column dataField='quantity' minWidth={140} caption='Số lượng' alignment='right'></Column>
                ...
                <Column alignment={"center"} caption={"Mức độ ưu tiên"} width={140} renderAsync={true}></Column>
