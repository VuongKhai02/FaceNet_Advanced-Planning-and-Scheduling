...
export const BOMBodyCardAddInfo: React.FC<BOMBodyCardAddInfoProps> = observer(({ isOpen = false, setClose }) => {
                ...
                <div>
                    <div className='table-responsive'>
                        ...
                        <DataGrid
                            ...
                            <Toolbar>
                                <ToolbarItem>
                                    <Button onClick={handleAddNewInfoMaterial} icon='add' text='Thêm vật tư' />
                                </ToolbarItem>
                                <ToolbarItem>
                                    <Button onClick={() => setIsVisibleImportFile(true)} icon='upload' text='Import file' />
                                </ToolbarItem>
                            </Toolbar>
                            <HeaderFilter
                                visible={true}
