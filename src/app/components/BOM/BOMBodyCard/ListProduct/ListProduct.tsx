        ...
        <div>
            ...
            >
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <Column type={"buttons"} caption={"Thao tác"} alignment="center" cellRender={() =>
                                            <div>
                                                <SvgIcon onClick={() => { }} tooltipTitle="Danh sách vật tư thay thế" sizeIcon={17} icon="assets/icons/EyeOpen.svg" textColor="#FF7A00" style={{ marginLeft: 35 }} />
                                            </div>} />
                ...
                <SearchPanel visible={true}
                    width={240}
                    placeholder="Nhập thông tin và nhấn Enter để tìm kiếm"
                />
                ...
                <Column type={'buttons'} caption={"Thao tác"} alignment="left" cellRender={() =>
                    <div style={{ display: "flex", justifyContent: "center" }}>
                        <SvgIcon onClick={() => setIsDetailBOMTemplate(true)} tooltipTitle="Thông tin" sizeIcon={17} textSize={17} icon="assets/icons/InfoCircle.svg" textColor="#FF7A00" style={{ marginRight: 17 }} />
