                            ...
                            <div>
                                ...
                                <div>
                                    <Table
                                        ...
                                        pagination={false}
                                    >
                                        <Table.Column title="Step1" dataIndex="step1" key="step1" align="left" render={() => <TextBox placeholder="Nhập" key="step1" />} />
                                        <Table.Column title="Step2" dataIndex="step2" key="step2" align="center" render={() => <TextBox placeholder="Nhập" key="step2" />} />
                                        <Table.Column title="Step3" dataIndex="step3" key="step3" align="center" render={() => <TextBox placeholder="Nhập" key="step3" />} />
                                        <Table.Column title="Step4" dataIndex="step4" key="step4" align="center" render={() => <TextBox placeholder="Nhập" key="step4" />} />
                                        <Table.Column title="Step5" dataIndex="step5" key="step5" align="center" render={() => <TextBox placeholder="Nhập" key="step5" />} />
                                        <Table.Column title="Step6" dataIndex="step6" key="step6" align="center" render={() => <TextBox placeholder="Nhập" key="step6" />} />
                                        <Table.Column title="Step7" dataIndex='step7' key="step7" align="center" render={() => <TextBox placeholder="Nhập" key="step7" />} />
                                        <Table.Column title="Step8" dataIndex='step8' key="step8" align="center" render={() => <TextBox placeholder="Nhập" key="step8" />} />
                                        <Table.Column title="Step9" dataIndex='step9' key="step9" align="center" render={() => <TextBox placeholder="Nhập" key="step9" />} />
