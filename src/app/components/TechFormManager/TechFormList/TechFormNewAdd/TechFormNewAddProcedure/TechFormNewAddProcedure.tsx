                    ...
                    <div className='table-responsive'>
                                ...
                                <Column alignment='left' caption='Công nghệ In/Printing Technology' fixed>
                                    ...
                                    <Column dataField="" caption="Back" width={50} />
                                        ...
                                        <Column
                                            ...
                                            cellRender={() => <TextBox className='inputRow' placeholder='--Nhập--' />}
                                        />
                                        <Column
                                            dataField='method'
                        ...
                        <div style={{ marginTop: 30 }}>
                            <div>
                                ...
                                <DataGrid
                                    ...
                                    <Column
                                        dataField='other'
                                        caption='Khác/Other'
                                        cellRender={() => <TextBox className='inputRow' placeholder='--Nhập--' />}></Column>
                                    <Column
                                        dataField='structure'
                                        caption='Cấu trúc/Structure'
                                        cellRender={() => <TextBox className='inputRow' placeholder='--Nhập--' />}
                                    />
                                    <Column type={"buttons"} caption={""} alignment='center'>
                                        <ButtonIcon icon='add' />
                            ...
                            <div style={{ marginTop: 30 }}>
                                ...
                                <DataGrid dataSource={rowData} keyExpr='id' showBorders={true} showRowLines={true} showColumnLines={true}>
                                    <Column dataField='id' caption='No.' alignment='left' width={100} />
                                    <Column
                                        dataField='content'
