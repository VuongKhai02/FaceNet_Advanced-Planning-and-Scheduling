...
export const ProductionID: React.FC<ProductionID> = observer(({ isOpen = false, setClose, status = "", p_id = "", p_cardName = "" }) => {
    ...
    return (
        <>
            {isDeclareInfo ? (
                <MachineID isOpen={isDeclareInfo} setClose={() => setisDeclareInfo(false)} p_id={p_id} p_cardName={p_cardName} />
            ) : (
                <div>
