        ...
        <div
            ...
            <div style={{ marginTop: 20 }}>
                <Button
                    ...
                    onClick={() => setIsVisibleQMSProcessResponsiblePerson(true)}
                    width={300}
                />
            </div>
            <div style={{ marginTop: 20 }}>
                ...
                <div>
                    <div className='table-responsive'>
                        ...
                        <PopupWO
                            ...
                            modalTitle={<div>Xem chi tiết QR code WO</div>}
                            width={1000}
                        ...
                        <DataGrid
                            ...
                            <Toolbar>
                                ...
                                <ToolbarItem location='after'>
                                    <Button hint='Xuất Excel' icon='download' text='Xuất Excel' />
                                </ToolbarItem>
