                ...
                <div className='table-responsive'>
                    ...
                    <DataGrid
                        ...
                        <PopupScanBarCode
                            ...
                            modalContent={
                                <div>
                                    <Barcode value='Nguyen Minh Son' textAlign='center' font='monospace' />
                                </div>
                            }
                            modalTitle={
                        ...
                        <PopupDetailBoxCard
                            ...
                            modalContent={
                                <div>
                                    <h3>
                                        <p style={{ marginTop: 20 }}>Xem chi tiết hộp chứa thẻ</p>
                                    </h3>
                        ...
                        <PopupAddBoxCard
                            ...
                            modalContent={
                                <div>
                                    <h3>
                                        <p style={{ marginTop: 20 }}>Thêm mới hộp chứa thẻ</p>
                                    </h3>
                                    <div style={{ marginTop: 40, marginBottom: 30 }}>
                                        <table style={{ display: "flex", justifyContent: "space-between" }}>
                                            <td>
