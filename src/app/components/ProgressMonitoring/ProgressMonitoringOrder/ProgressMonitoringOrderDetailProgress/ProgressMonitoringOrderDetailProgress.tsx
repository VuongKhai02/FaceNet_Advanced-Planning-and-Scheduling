...
const data = [
    { manufactureCode: '134359', productionCode: 'SP_001', cardName: 'Visa TPBank', planQuantity: '105', finishName: '50', finishRatio: '38%', errorRatio: '5%', startTime: '09/08/2023', endTime: '19/08/2023' },
    { manufactureCode: '134352', productionCode: 'SP_001', cardName: 'Visa TPBank', planQuantity: '105', finishName: '50', finishRatio: '38%', errorRatio: '5%', startTime: '09/08/2023', endTime: '19/08/2023' },
    { manufactureCode: '134353', productionCode: 'SP_001', cardName: 'Visa TPBank', planQuantity: '105', finishName: '50', finishRatio: '38%', errorRatio: '5%', startTime: '09/08/2023', endTime: '19/08/2023' }
];
const { Step } = Steps;
const items = [
    {
        status: 'Phê duyệt', time: '01/7/2023', color: 'green'
    },
    {
        status: 'Lập kế hoạch', time: '05/7/2023', color: 'green'
    },
    {
        status: 'Đang sản xuất', time: '10/07/2023', color: 'gray'
    },
    {
        status: 'Chờ nhập kho', time: '4', color: 'pink'
    },
    {
        status: 'Hoàn thành', time: '5', color: 'pink'
    }
                ...
                <div className="box__shadow-table-responsive">
                    <div className="table-responsive">
                        ...
                        <div style={{ marginBottom: 30, marginTop: 50 }}>
                            ...
                            <Steps current={2} size="small" labelPlacement="vertical" style={{ width: '60%', marginLeft: 300, marginTop: 40 }} >
                                {items.map((item, index) => (
                                    <Step key={index} title={
                                        <div className="custom-step" style={{ color: item.color }}>
                                            {item.status}
                                        </div>
                                    } description={<div className="custom-step" style={{ color: item.color }}>
                                        {item.time}
