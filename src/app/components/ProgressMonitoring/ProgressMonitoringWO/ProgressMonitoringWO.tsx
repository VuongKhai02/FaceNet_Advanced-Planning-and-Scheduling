        ...
        <React.Fragment>
            <div className='options'>
                ...
                <Form colCount={2} className={"collapsible"}>
                    ...
                    <SimpleItem dataField={"Lựa chọn thời gian"}>
            ...
            <Scheduler
                ...
                <Resource fieldExpr='line' allowMultiple={false} dataSource={data} label='Line' displayExpr={"lineName"} />
                <Resource fieldExpr='state' allowMultiple={false} dataSource={data} label='State' />
