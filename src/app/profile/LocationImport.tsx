...
const ROUTING_PATH = "/locationImport";

const fileExtensions = [".csv", ".xls", ".xlsx"];

const LocationImport = observer(() => {
    ...
    const onClick = () => {
        ...
        axios
            .post(PLANNING_API_URL + "/services/api/location-rfid/import", data, { headers })
            .then((response) => {
            ...
            <div>
                ...
                <div className='widget-container'>
                    <div className='fileuploader-container'>
                        ...
                        <a href='/Location-RFID.xlsx' className='note'>
                            Tải Location Template
                        </a>
                        <Button1 className='button-upload' icon='exportxlsx' text='Import Location' type='default' onClick={onClick} />
                    </div>
                </div>
            </div>
        </>
