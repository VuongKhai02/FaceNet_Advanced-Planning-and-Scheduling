...
const ROUTING_PATH = "/coittImport";

const fileExtensions = [".csv", ".xls", ".xlsx"];

const COITTImport = observer(() => {
    ...
    const onClick = () => {
        ...
        axios
            .post(PLANNING_API_URL + "/services/api/coitt/import", data, { headers })
            .then((response) => {
            ...
            <div>
                ...
                <div className='widget-container'>
                    <div className='fileuploader-container'>
                        ...
                        <a href='/COITT_SAP.xlsx' className='note'>
                            Tải COITT Template
                        </a>
                        <Button1 className='button-upload' icon='exportxlsx' text='Import COITT' type='default' onClick={onClick} />
                    </div>
                </div>
            </div>
        </>
...
export default COITTImport;

registerScreen({
    component: COITTImport,
    caption: "Import COITT",
    screenId: "COITTImport",
    menuOptions: {
