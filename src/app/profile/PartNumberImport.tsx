...
const ROUTING_PATH = "/partNumberImport";

const fileExtensions = [".csv", ".xls", ".xlsx"];

const PartNumberImport = observer(() => {
    ...
    const onClick = () => {
        ...
        axios
            .post(PLANNING_API_URL + "/services/api/part-number/import", data, { headers })
            .then((response) => {
            ...
            <div>
                ...
                <div className='widget-container'>
                    <div className='fileuploader-container'>
                        ...
                        <a href='/List_PartNumber.csv' className='note'>
                            Tải Part Number Template
                        </a>
                        <Button1 className='button-upload' icon='exportxlsx' text='Import part number' type='default' onClick={onClick} />
                    </div>
                </div>
...
export default PartNumberImport;

registerScreen({
    component: PartNumberImport,
    caption: "2. Import PartNumber",
    screenId: "PartNumberImport",
    menuOptions: {
